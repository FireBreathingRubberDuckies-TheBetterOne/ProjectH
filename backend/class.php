<?php
    ...
    require_once(__ROOT__.'/backend/classes/orderHandling.class.php'); $orderClass = new OrderHandling(); //A rendelések információit itt tudjuk megtekentini egy nagy lista foemájában
